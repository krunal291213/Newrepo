    ...
    try:
        for i in range(arg-1, len(links)):
            ...
            if "acecwply" in url:
                ...
                api_url_call = f"https://cptest-xi.vercel.app/ITsGOLU_OFFICIAL?url={url}"
                keys_string = ""
                mpd = None
                try:
                ...
                headers = {'host': 'api.classplusapp.com', 'x-access-token': f'{eyJjb3Vyc2VJZCI6Ijc3ODkxNCIsInR1dG9ySWQiOm51bGwsIm9yZ0lkIjo3NjMzMjAsImNhdGVnb3J5SWQiOm51bGx9}', 'accept-language': 'EN', 'api-version': '35', 'app-version': '1.4.118', 'build-number': '118', 'connection': 'Keep-Alive', 'content-type': 'application/json', 'device-details': 'Xiaomi_Redmi 7_SDK-32', 'device-id': 'c28d3cb16bbdac01', 'region': 'IN', 'user-agent': 'Mobile-Android', 'webengage-luid': '00000187-6fe4-5d41-a530-26186858be4c', 'accept-encoding': 'gzip'}
                params = {"url": f"{url}"}
                response = requests.get('https://api.classplusapp.com/cams/uploader/video/jw-signed-url', headers=headers, params=params)
                url = response.json()['url']  
           
            elif 'videos.classplusapp' in url:
                url = requests.get(f'https://api.classplusapp.com/cams/uploader/video/jw-signed-url?url={url}', headers={'x-access-token': f'{eyJjb3Vyc2VJZCI6Ijc3ODkxNCIsInR1dG9ySWQiOm51bGwsIm9yZ0lkIjo3NjMzMjAsImNhdGVnb3J5SWQiOm51bGx9}'}).json()['url']
